...
static void FrameRender(ImGui_ImplVulkanH_Window* wd, ImDrawData* draw_data, Renderer& renderer, const Scene& scene)
{
    ...
    {
        // Free command buffers allocated by Engine::GetCommandBuffer
...
void Engine::FlushCommandBuffer(VkCommandBuffer commandBuffer)
{
...
void Engine::SubmitResourceFree(std::function<void()>&& func)
{
