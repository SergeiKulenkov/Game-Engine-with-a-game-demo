...
void Image::AllocateMemory()
{
	...
	m_DescriptorSet = (VkDescriptorSet)ImGui_ImplVulkan_AddTexture(m_ImageView, m_ImageInfo.imageLayout);
}

void Image::Release()
{
	Engine::SubmitResourceFree([sampler = m_Sampler, imageView = m_ImageView, image = m_Image,
